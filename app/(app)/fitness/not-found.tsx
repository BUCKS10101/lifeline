  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-start gap-5 py-20">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-muted-foreground">That workout, exercise or template does not exist.</p>
      </div>
      <Link href="/fitness" className={buttonVariants({ className: "h-12 px-5 text-base font-semibold" })}>Back to Fitness</Link>
    </div>
  );
}
