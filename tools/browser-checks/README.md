...
| `09-wellness-pages` | The sleep, water and protein pages and the dashboard card: chart points, zero-filled days and average text checked against numbers worked out from a 25-morning seed and the API, ranges and the goal line, tooltips, logging (with the live preview), undo, edit and delete, another-day logging, hidden metrics redirecting to Today, the 2 x 2 dashboard grid, overflow and touch targets at 390/768/1280 px, and the loading and unavailable states |
